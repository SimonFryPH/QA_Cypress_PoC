...
cy.config().screenSizes.forEach((size) => {
  ...
  describe('Header, Footer and menus ' + size[0] + ', ' + size[1], async function () {
    ...
    it('Should access to the side menu bar', function () {
      ...
      cy.get('[__type="AccordionItemHeader"]').eq(12).should('include.text', 'Holidays & Short Breaks')
      //
      cy.get('[__type="AccordionItemHeader"]').eq(12).click() // Menu expand
      ...
      cy.get('[href="/caravan-holidays/half-board-catered-inclusive"]').should('include.text', 'Flexible Dining Options')
      ...
      cy.get('[__type="AccordionItemHeader"]').eq(12).click() // Menu collapse


      cy.get('[__type="AccordionItemHeader"]').eq(13).should('include.text', 'Touring & Camping')
      //
      ...
      cy.get('[href="/touring-and-camping/half-board-catered-inclusive"]').should('include.text', 'Flexible Dining Options')
      ...
      cy.get('[__type="AccordionItemHeader"]').eq(14).should('include.text', 'Holiday Home Ownership')
      //
