...
cy.config().screenSizes.forEach((size) => {
    ...
    describe('my.parkholidays.com ' + size[0] + ', ' + size[1], async function () {
        ...
        describe('Should log in with valid credentials ' + size[0] + ', ' + size[1], function () {
            ...
            it('and view Make Payment Page',  function () {
